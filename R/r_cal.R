...
nonRgroups = "sas|pydata|knime|odsc|python meetup|python and data|python for artificial|apache druid|quantum computing|pgh data|birmingham alabama software|fresno data|pune big data|wids|women in data|ai bookclub|kaggle|data scientist|data science enthusiasts|applied data science|atlytics|advanced analytics|big data|open data|data science a|data science |thinking thursday|open source|data science:|machine learning|artificial intelligence|analytics meetup|data viz|@ai|women in machine|datascrum|datacouncil|mbit|nycfinance|bangalore natural language|digital science|data visualization|diagnostics|bio-data|dataquest|datachangers|digital:|ar labs|data savvy|bioinformatics|computational|in tech|society|hackers|analytics vidhya"
